...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 550, 410, 30, 20, 1),
    ...
    new Obstaculo('imagenes/valla_vertical.png', 460, 380, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 470, 410, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 450, 250, 30, 30, 1),
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 765, 170, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 250, 350, 10, 10, 1, {desdeX: 250, hastaX: 350, desdeY: 350, hastaY: 500}),
    new ZombieCaminante('imagenes/zombie2.png', 290, 220, 10, 10, 1, {desdeX: 290, hastaX: 590, desdeY: 190, hastaY: 300}),
    new ZombieCaminante('imagenes/zombie3.png', 260, 240, 10, 10, 1, {desdeX: 1, hastaX: 900, desdeY: 1, hastaY: 200}),
    new ZombieCaminante('imagenes/zombie4.png', 700, 500, 10, 10, 1, {desdeX: 700, hastaX: 900, desdeY: 400, hastaY: 500}),
    new ZombieConductor('imagenes/tren_horizontal.png',400,322,90,30, 7,{desdeX: 20, hastaX: 850, desdeY: 0, hastaY: 322},"h"),
    new ZombieConductor('imagenes/tren_vertical.png',644,0,30,90,5,{desdeX: 0, hastaX: 850, desdeY: 0, hastaY: 470},"v"),
    new ZombieConductor('imagenes/tren_vertical.png',678,0,30,90,6,{desdeX: 0, hastaX: 850, desdeY: 0, hastaY: 470},"v")
  ]
...
Juego.dibujar = function() {
  ...
  if(!this.terminoJuego() && !this.ganoJuego()){
    ...
    // Linea de llegada
    Dibujante.dibujarRectangulo("gold", 759, 544, 128, 20);
  }  
